...
if __name__ == '__main__':
    [data_txt, files] = read_novel('E:\桌面文件\课程学习类\研究生课程\研一下\DL-NLP\第一次大作业\jyxstxtqj_downcc.com')
    ...
    [test_txt, files] = read_novel1('E:\桌面文件\课程学习类\研究生课程\研一下\DL-NLP\第一次大作业\jyxstxtqj_downcc.com')
    ...
    print(files)
    print(result)
    topic0 = sorted(Topic_fre0.items(), key=lambda x: x[1], reverse=True)
    topic1 = sorted(Topic_fre1.items(), key=lambda x: x[1], reverse=True)
    topic2 = sorted(Topic_fre2.items(), key=lambda x: x[1], reverse=True)
    topic3 = sorted(Topic_fre3.items(), key=lambda x: x[1], reverse=True)
    topic4 = sorted(Topic_fre4.items(), key=lambda x: x[1], reverse=True)
    topic5 = sorted(Topic_fre5.items(), key=lambda x: x[1], reverse=True)
    topic6 = sorted(Topic_fre6.items(), key=lambda x: x[1], reverse=True)
    topic7 = sorted(Topic_fre7.items(), key=lambda x: x[1], reverse=True)
    topic8 = sorted(Topic_fre8.items(), key=lambda x: x[1], reverse=True)
    topic9 = sorted(Topic_fre9.items(), key=lambda x: x[1], reverse=True)
    topic10 = sorted(Topic_fre10.items(), key=lambda x: x[1], reverse=True)
    topic11 = sorted(Topic_fre11.items(), key=lambda x: x[1], reverse=True)
    topic12 = sorted(Topic_fre12.items(), key=lambda x: x[1], reverse=True)
    topic13 = sorted(Topic_fre13.items(), key=lambda x: x[1], reverse=True)
    topic14 = sorted(Topic_fre14.items(), key=lambda x: x[1], reverse=True)
    topic15 = sorted(Topic_fre15.items(), key=lambda x: x[1], reverse=True)
    print(topic0[0:10])
    print(topic1[0:10])
    print(topic2[0:10])
    print(topic3[0:10])
